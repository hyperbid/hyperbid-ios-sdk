...
-(void) loadAd:(NSString*) ofmPlacementID serverInfo:(NSDictionary *)serverInfo extra:(NSDictionary *)extra customData:(NSDictionary*)customData delegate:(id<OFMAdapterBaseDelegate>)delegate;
